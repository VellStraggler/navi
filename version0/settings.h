...
constexpr int NEW_FRAME_PARTICLES = 2;
...
constexpr bool TRANSCRIBE = true;
constexpr bool VOLUME_AFFECTS_COLOR = false;
constexpr uint8_t VOLUME_COLOR_EFFECT[] = {255,0,0};